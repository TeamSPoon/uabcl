...
public final class Functions extends SubLTrampolineFile {
  ...
  public static final SubLObject apply(final SubLObject function, final SubLObject arg, final SubLObject[] restArgs) {
    ...
    ArrayList list = new ArrayList(1 + restLength + 16);
    ...
    if (!lastList.isList()) {
      throw new SubLException("Invalid argument supplied to APPLY: " + arg + ".");
    }
    Resourcer resourcer = Resourcer.getInstance();
    if (lastList != NIL) {
  ...
  public static final SubLObject funcall_stats(SubLObject minNumOfCalls) {
    ...
    ArrayList list = SubLCompiledFunction.funcallCountsArray;
  ...
  public static final class SubLFuncallCountComaprator implements Comparator {
    private int arity = 0;
    public SubLFuncallCountComaprator(int arity) {
      this.arity = arity;
    }
    public int compare(Object o1, Object o2) {
      SubLCompiledFunction.FuncallCounts obj1 = (SubLCompiledFunction.FuncallCounts)o1;
      SubLCompiledFunction.FuncallCounts obj2 = (SubLCompiledFunction.FuncallCounts)o2;
      if (obj1.counts[arity] == obj2.counts[arity]) {
        return 0;
      }
      return obj1.counts[arity] < obj2.counts[arity] ? 1 : -1; 
    }
