  ...
  public final SubLObject funcall(final SubLObject[] incomingArgs) {
    ...
    try {
      ...
      if (actualArity < getRequiredArgCount()) {
        throw new SubLException("Error: " + this + " called with too few arguments: " + incomingArgs);
      }
      if ((actualArity > applyArity)  && (!allowsRest)) {
        throw new SubLException("Error: " + this + " called with too many arguments: " + incomingArgs);
      }
