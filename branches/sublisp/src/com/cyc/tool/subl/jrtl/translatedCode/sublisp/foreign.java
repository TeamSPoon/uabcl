...
public final class foreign extends SubLTranslatedFile {
        ...
        }
        {
          ...
          try {
            ...
            if ((NIL != foreign_shared_library_p(moniker))) {
              ...
              Symbols.set($foreign_shared_libraries$, conses_high.acons(moniker, properties, $foreign_shared_libraries$.getDynamicValue(thread)));
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 1814) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 2140) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 2327) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 2517) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 2870) 
  ...
  /** Unassociate all knowledge of the foreign shared library identified
   by the moniker. */
  @SubL(source = "sublisp/foreign.lisp", position = 3042) 
          ...
          if ((NIL != foreign_shared_library_p(moniker))) {
            {
              ...
              Symbols.set($foreign_shared_libraries$, Sequences.delete(tuple, $foreign_shared_libraries$.getDynamicValue(thread), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED));
              okP = T;
            }
          }
        } finally {
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 3620) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 3710) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 3920) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 4306) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 4410) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 4605) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 4783) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 4992) 
  ...
  /** Given the moniker fo a previously declared shared library, load the 
   ...
   passed in. */
  @SubL(source = "sublisp/foreign.lisp", position = 5214) 
        ...
        }
        {
          ...
          try {
            ...
            if ((NIL != foreign_shared_library_loadedP(moniker))) {
              ...
              Symbols.set($active_foreign_shared_libraries$, cons(moniker, $active_foreign_shared_libraries$.getDynamicValue(thread)));
            }
          } finally {
            {
              SubLObject _prev_bind_0 = Threads.$is_thread_performing_cleanupP$.currentBinding(thread);
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 5975) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 6612) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 6883) 
      ...
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
        ...
        try {
          ...
          if ((NIL != foreign_shared_library_loadedP(moniker))) {
            ...
            Symbols.set($active_foreign_shared_libraries$, Sequences.delete(moniker, $active_foreign_shared_libraries$.getDynamicValue(thread), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED));
            success = T;
          }
        } finally {
          {
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 7664) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 7829) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 8184) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 8569) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 8700) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 8981) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 9304) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 9483) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 9673) 
  public static final SubLObject define_foreign_function(SubLObject macroform, SubLObject v_environment) {
    {
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 10915) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 13611) 
  ...
  /** @stub */
  @SubL(source = "sublisp/foreign.lisp", position = 13922) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 14020) 
  public static final SubLObject ffuncall(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
      SubLObject symbol = NIL;
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 14133) 
  public static final SubLObject make_dummy_arg_list(SubLObject arglist) {
    return arglist;
  }

  @SubL(source = "sublisp/foreign.lisp", position = 14263) 
  ...
  @SubL(source = "sublisp/foreign.lisp", position = 15541) 
  ...
  public static final SubLObject setup_foreign_file() {
    // CVS_ID("Id: foreign.lisp,v 1.13 2006/02/22 19:54:20 goolsbey Exp ");
    return NIL;
  }
  ...
  public static final SubLList $list14 = list(makeSymbol("SYMBOL"), makeSymbol("ARGLIST", "SUBLISP"), makeSymbol("RULES", "SUBLISP"));
  ...
  public static final SubLList $list17 = list(makeSymbol("&KEY"), list(makeSymbol("CALLING-CONVENTION", "SUBLISP"), makeKeyword("C")), makeSymbol("FOREIGN-SHARED-LIBRARY", "SUBLISP"), makeSymbol("FOREIGN-NAME", "SUBLISP"), makeSymbol("ARG-CONVERSION", "SUBLISP"), list(makeSymbol("RETURN-TYPE", "SUBLISP"), makeKeyword("VOID")));
  ...
  public static final SubLList $list33 = list(makeSymbol("SYMBOL"), makeSymbol("&REST"), makeSymbol("ARGS", "SUBLISP"));
  public static final SubLSymbol $sym34$FUNCALL = makeSymbol("FUNCALL");
  public static final SubLSymbol $sym35$DEF_FOREIGN_FUNCTION = makeSymbol("DEF-FOREIGN-FUNCTION", "SUBLISP");
  ...
  public static final SubLSymbol $sym40$_VAL = makeSymbol("%VAL", "SUBLISP");
  public static final SubLSymbol $sym41$FFUNCALL = makeSymbol("FFUNCALL", "SUBLISP");
  public static final SubLSymbol $sym42$PIF = makeSymbol("PIF");
  public static final SubLList $list43 = list(makeSymbol("ALIEN-NULL-PTR?", "SUBLISP"), makeSymbol("%VAL", "SUBLISP"), makeKeyword("C"));
  public static final SubLSymbol $sym44$RET = makeSymbol("RET");
  public static final SubLList $list45 = list(list(makeSymbol("RET"), makeSymbol("%VAL", "SUBLISP")));
