...
public class StreamsLow extends SubLTrampolineFile {
  ...
  public static final SubLObject open(SubLObject fileSpec, SubLObject[]keys) {
    ...
    if ((keys.length % 2) == 1) {
      throw new SubLException("Need an even number of arguments to OPEN.");
    }
    ...
    for (int i = 0, size = keys.length; i < size; i += 2) {
      ...
      if (curKey == DIRECTION_KEYWORD) {
        ...
        throw new SubLException("OPEN got unexpected parameter " + curKey + ".");
      }
    }
  ...
  public void initializeVariables() {
    ...
    SubLInputTextStream standardInputStream = SubLStreamFactory.makeInputTextStream(System.in);
