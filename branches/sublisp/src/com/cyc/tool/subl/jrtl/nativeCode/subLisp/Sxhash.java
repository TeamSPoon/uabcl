...
public class Sxhash extends SubLTrampolineFile {
  ...
  public static final SubLObject sxhash(SubLObject obj) {
    if (obj.isStructure()) {
      ...
      return (func == null) ? ZERO_INTEGER : SubLNumberFactory.makeInteger(Numbers.truncateToFixnum(func.processItem(obj).intValue()));
    ...
    return SubLNumberFactory.makeInteger(Numbers.truncateToFixnum(obj.hashCode(0)));
  }
