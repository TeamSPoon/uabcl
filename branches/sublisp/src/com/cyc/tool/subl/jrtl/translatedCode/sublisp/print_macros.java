...
public final class print_macros extends SubLTranslatedFile {
  ...
  @SubL(source = "sublisp/print-macros.lisp", position = 600) 
  public static final SubLObject print_unreadable_object(SubLObject macroform, SubLObject v_environment) {
    {
  ...
  @SubL(source = "sublisp/print-macros.lisp", position = 1445) 
  ...
  public static final SubLObject setup_print_macros_file() {
    // CVS_ID("Id: print-macros.lisp,v 1.14 2007/08/16 22:30:36 tbrussea Exp ");
    return NIL;
  }

  //// Internal Constants

  public static final SubLList $list0 = list(list(makeSymbol("OBJECT", "SUBLISP"), makeSymbol("STREAM"), makeSymbol("&KEY"), makeSymbol("TYPE"), IDENTITY), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLSymbol $sym18$POINTER = makeSymbol("POINTER", "SUBLISP");
