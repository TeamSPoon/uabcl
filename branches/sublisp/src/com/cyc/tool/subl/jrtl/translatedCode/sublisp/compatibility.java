...
public final class compatibility extends SubLTranslatedFile {
  ...
  @SubL(source = "sublisp/compatibility.lisp", position = 351) 
  ...
  @SubL(source = "sublisp/compatibility.lisp", position = 1474) 
  ...
  /** Given the access styles :private and :public, and the types :binary and
   ...
   computationally. */
  @SubL(source = "sublisp/compatibility.lisp", position = 2563) 
  public static final SubLObject with_streamed_file_internal(SubLObject macroform, SubLObject v_environment) {
    {
        ...
        current = current.first();
        {
          ...
          if ((NIL == current)) {
            current = temp;
            {
              ...
              return list($sym25$CLET, list(stream_var), list($sym26$CUNWIND_PROTECT, list($sym27$PROGN, open_clause, listS($sym25$CLET, list(list(stream, stream_var)), ConsesLow.append(body, NIL))), list($sym28$PWHEN, list($sym29$STREAMP, stream_var), list($sym30$CLOSE, stream_var))));
            }
          } else {
  ...
  @SubL(source = "sublisp/compatibility.lisp", position = 3861) 
  public static final SubLObject with_text_file(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
      cdestructuring_bind.destructuring_bind_must_consp(current, datum, $list31);
      {
        ...
        current = current.first();
        {
          ...
          if ((NIL == current)) {
            ...
            {
              SubLObject body = current;
              return listS($sym19$WITH_STREAMED_FILE_INTERNAL, listS(stream, filename, direction, $list32), ConsesLow.append(body, NIL));
            }
          } else {
  ...
  @SubL(source = "sublisp/compatibility.lisp", position = 4061) 
  public static final SubLObject with_private_text_file(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
      cdestructuring_bind.destructuring_bind_must_consp(current, datum, $list31);
      {
        ...
        current = current.first();
        {
          ...
          if ((NIL == current)) {
            ...
            {
              SubLObject body = current;
              return listS($sym19$WITH_STREAMED_FILE_INTERNAL, listS(stream, filename, direction, $list33), ConsesLow.append(body, NIL));
            }
          } else {
            cdestructuring_bind.cdestructuring_bind_error(datum, $list31);
          }
  ...
  @SubL(source = "sublisp/compatibility.lisp", position = 4238) 
  public static final SubLObject with_binary_file(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
      cdestructuring_bind.destructuring_bind_must_consp(current, datum, $list31);
      {
        ...
        current = current.first();
        {
          ...
          if ((NIL == current)) {
            ...
            {
              SubLObject body = current;
              return listS($sym19$WITH_STREAMED_FILE_INTERNAL, listS(stream, filename, direction, $list34), ConsesLow.append(body, NIL));
            }
          } else {
            cdestructuring_bind.cdestructuring_bind_error(datum, $list31);
          }
  ...
  @SubL(source = "sublisp/compatibility.lisp", position = 4410) 
  public static final SubLObject with_private_binary_file(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
      cdestructuring_bind.destructuring_bind_must_consp(current, datum, $list31);
  ...
  @SubL(source = "sublisp/compatibility.lisp", position = 4783) 
  public static final SubLObject default_struct_print_function(SubLObject object, SubLObject stream, SubLObject depth) {
    {
      ...
      if ((NIL != print_high.$print_readably$.getDynamicValue(thread))) {
      ...
      } else {
        {
          ...
          streams_high.write_string($str36$__, stream_2, UNPROVIDED, UNPROVIDED);
          PrintLow.write(Types.type_of(object_1), new SubLObject[] {$kw37$STREAM, stream_2});
          streams_high.write_char(Characters.CHAR_space, stream_2);
          PrintLow.write(Equality.pointer(object_1), new SubLObject[] {$kw37$STREAM, stream_2, $kw38$BASE, SIXTEEN_INTEGER});
  ...
  public static final SubLObject setup_compatibility_file() {
    // CVS_ID("Id: compatibility.lisp,v 1.11 2006/03/10 20:02:54 goolsbey Exp ");
    return NIL;
  }
  ...
  public static final SubLList $list16 = list(list(makeSymbol("STREAM"), makeSymbol("FILENAME", "SUBLISP"), makeSymbol("DIRECTION", "SUBLISP"), makeSymbol("ACCESS", "SUBLISP"), makeSymbol("TYPE")), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLSymbol $sym19$WITH_STREAMED_FILE_INTERNAL = makeSymbol("WITH-STREAMED-FILE-INTERNAL", "SUBLISP");
  ...
  public static final SubLSymbol $sym30$CLOSE = makeSymbol("CLOSE");
  public static final SubLList $list31 = list(list(makeSymbol("STREAM"), makeSymbol("FILENAME", "SUBLISP"), makeSymbol("DIRECTION", "SUBLISP")), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  public static final SubLList $list32 = list(makeKeyword("PUBLIC"), makeKeyword("TEXT"));
  public static final SubLList $list33 = list(makeKeyword("PRIVATE"), makeKeyword("TEXT"));
  public static final SubLList $list34 = list(makeKeyword("PUBLIC"), makeKeyword("BINARY"));
  public static final SubLList $list35 = list(makeKeyword("PRIVATE"), makeKeyword("BINARY"));
