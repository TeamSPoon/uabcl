...
public final class condition_macros extends SubLTranslatedFile {
  ...
  @SubL(source = "sublisp/condition-macros.lisp", position = 824) 
  public static final SubLObject with_simple_restart(SubLObject macroform, SubLObject v_environment) {
    {
  ...
  @SubL(source = "sublisp/condition-macros.lisp", position = 1335) 
  public static final SubLObject with_simple_restart_internal(SubLObject name, SubLObject format_control, SubLObject format_arguments, SubLObject body) {
    {
      ...
      return list($sym3$CLET, list(list(tag, ((NIL != name) ? ((SubLObject) list($sym4$QUOTE, name)) : list($sym4$QUOTE, tag))), dummy), list($sym5$CCATCH, tag, dummy, list($sym6$IGNORE, dummy), listS($sym3$CLET, list(list($sym7$_RESTARTS_, listS($sym8$CONS, listS($sym9$LIST, tag, format_control, ConsesLow.append(format_arguments, NIL)), $list10))), ConsesLow.append(body, NIL))));
    }
  }

  /** Trampoline CYC-LISP:ERROR to SL:ERROR. */
  @SubL(source = "sublisp/condition-macros.lisp", position = 1743) 
  public static final SubLObject with_sublisp_error_handling(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
      SubLObject body = current;
  ...
  @SubL(source = "sublisp/condition-macros.lisp", position = 2445) 
  ...
  @SubL(source = "sublisp/condition-macros.lisp", position = 2537) 
  ...
  @SubL(source = "sublisp/condition-macros.lisp", position = 3224) 
  public static final SubLObject ignore_errors(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
      SubLObject body = current;
  ...
  @SubL(source = "sublisp/condition-macros.lisp", position = 3591) 
  public static final SubLObject ignore_errors_internal(SubLObject body) {
    {
      ...
      return list($sym3$CLET, list(tag), list($sym5$CCATCH, $kw14$IGNORE_ERRORS_TARGET, tag, list($sym6$IGNORE, tag), listS($sym15$WITH_ERROR_HANDLER, $list16, ConsesLow.append(body, NIL))));
    }
  }

  @SubL(source = "sublisp/condition-macros.lisp", position = 3844) 
  ...
  public static final SubLObject setup_condition_macros_file() {
    // CVS_ID("Id: condition-macros.lisp,v 1.17 2006/08/04 21:53:55 goolsbey Exp ");
    return NIL;
  }

  //// Internal Constants

  public static final SubLList $list0 = list(list(makeSymbol("NAME", "SUBLISP"), makeSymbol("FORMAT-CONTROL", "SUBLISP"), makeSymbol("&REST"), makeSymbol("FORMAT-ARGUMENTS", "SUBLISP")), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLSymbol $sym5$CCATCH = makeSymbol("CCATCH");
  public static final SubLSymbol $sym6$IGNORE = makeSymbol("IGNORE");
  public static final SubLSymbol $sym7$_RESTARTS_ = makeSymbol("*RESTARTS*", "SUBLISP");
  public static final SubLSymbol $sym8$CONS = makeSymbol("CONS");
  public static final SubLSymbol $sym9$LIST = makeSymbol("LIST");
  public static final SubLList $list10 = list(makeSymbol("*RESTARTS*", "SUBLISP"));
  ...
  public static final SubLList $list16 = list(makeSymbol("FUNCTION"), makeSymbol("IGNORE-ERRORS-HANDLER", "SUBLISP"));
