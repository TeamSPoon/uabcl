...
public final class Resourcer extends RuntimeException implements CommonSymbols {
  ...
  */
  ...
  public SubLObject[] acquireSubLObjectArray(ArrayList list) {
    if ((list == null) || (list.size() <= 0)) {
      return EMPTY_SUBL_OBJECT_ARRAY;
    }
    SubLObject[] result;
  ...
  private static final class ObjectArrayObjectPool extends ObjectPool {
  ...
  private static final class SubLObjectArrayObjectPool extends ObjectPool {
