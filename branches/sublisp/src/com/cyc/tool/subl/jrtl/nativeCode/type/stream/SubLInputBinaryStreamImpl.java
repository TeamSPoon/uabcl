...
public final class SubLInputBinaryStreamImpl extends AbstractSubLBinaryStream implements SubLInputBinaryStream, CommonSymbols {
  ...
  public final long numBytesAvailable() {
    ...
    try {
      ...
      throw new SubLException("Unable to get available bytes for stream.", e);
    }
  }
  ...
  public long readByteSequenceToPositiveInteger(int bytesInInteger) {
    ...
    if ((bytesInInteger > 8) || (bytesInInteger < 0)) {
      throw new SubLException("Bytes in integer is too large: " + bytesInInteger);
    }
    long result = 0;
    int curChar = -1;
  ...
  private final int readInternal() {
    ...
    while (true) {
      try {
        ...
        throw new SubLException("Unable to read character from stream: " + this, e);
      }
  ...
  public final int read(byte[] b) { //@note make this interruptable
    ...
    try {
      ...
      throw new SubLException("Unable to read character from stream.", e);
    }
  }
  ...
  public final long skip(long n) {
    ...
    try {
      ...
      throw new SubLException("Unable to skip characters.", e);
    }
  }
  ...
  public final void unread(int c) {
    ...
    try {
      ...
      throw new SubLException("Unable to unread character from stream.", e);
    }
  }
