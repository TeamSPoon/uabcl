...
public final class SubLCompiledFunction extends AbstractSubLFunction implements SubLFunction {
  ...
  public Method getMethod() {
    if (method == null) {
      try {
        method =  Class.forName(methodClassStr).getMethod(methodName, methodParameters);
      } catch (Exception e) {
  ...
  public final SubLObject apply(Object[] args) {
    ...
    try {
      ...
      if (e instanceof SubLProcess.TerminationRequest) {
        throw (SubLProcess.TerminationRequest)e;
      }
      throw new SubLException(e);
  ...
  */
  ...
  public static final ArrayList funcallCountsArray = SHOULD_MAINTAIN_FUNCALL_COUNTS ? new ArrayList() : null;
