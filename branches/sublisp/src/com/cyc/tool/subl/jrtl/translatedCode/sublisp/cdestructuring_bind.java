...
public final class cdestructuring_bind extends SubLTranslatedFile {
  ...
  @SubL(source = "sublisp/cdestructuring-bind.lisp", position = 990) 
  public static final SubLObject cdestructuring_bind(SubLObject macroform, SubLObject v_environment) {
    {
  ...
  @SubL(source = "sublisp/cdestructuring-bind.lisp", position = 1598) 
  ...
  @SubL(source = "sublisp/cdestructuring-bind.lisp", position = 1782) 
  ...
  @SubL(source = "sublisp/cdestructuring-bind.lisp", position = 1948) 
  ...
  @SubL(source = "sublisp/cdestructuring-bind.lisp", position = 2114) 
  ...
  @SubL(source = "sublisp/cdestructuring-bind.lisp", position = 2359) 
  public static final SubLObject bogus_unless(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
      SubLObject form = NIL;
  ...
  @SubL(source = "sublisp/cdestructuring-bind.lisp", position = 2459) 
  ...
  @SubL(source = "sublisp/cdestructuring-bind.lisp", position = 2925) 
  public static final SubLObject destructuring_bind_required_args(SubLObject pattern, SubLObject datum, SubLObject error, SubLObject body) {
    {
      ...
      SubLObject done = NIL;
      for (done = NIL; (!(((NIL != done)
            || (!(pattern.isCons()))))); done = done) {
        {
  ...
  public static final SubLObject setup_cdestructuring_bind_file() {
    // CVS_ID("Id: cdestructuring-bind.lisp,v 1.21 2007/04/18 20:24:37 rck Exp ");
    return NIL;
  }

  //// Internal Constants

  public static final SubLList $list0 = list(makeSymbol("PATTERN", "SUBLISP"), makeSymbol("DATUM", "SUBLISP"), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLSymbol $sym5$CDESTRUCTURING_BIND_ERROR = makeSymbol("CDESTRUCTURING-BIND-ERROR", "SUBLISP");
  ...
  public static final SubLList $list11 = list(makeSymbol("FORM", "SUBLISP"));
  public static final SubLList $list12 = list(list(makeSymbol("ERROR"), makeString("Malformed pattern ~S."), makeSymbol("PATTERN", "SUBLISP")));
  ...
  public static final SubLSymbol $sym17$DESTRUCTURING_BIND_MUST_CONSP = makeSymbol("DESTRUCTURING-BIND-MUST-CONSP", "SUBLISP");
  ...
  public static final SubLSymbol $sym28$DESTRUCTURING_BIND_MUST_LISTP = makeSymbol("DESTRUCTURING-BIND-MUST-LISTP", "SUBLISP");
  ...
  public static final SubLSymbol $sym45$PROPERTY_LIST_MEMBER = makeSymbol("PROPERTY-LIST-MEMBER", "SUBLISP");
