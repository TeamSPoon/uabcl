 ...
 * $Id: ComplexArray_UnsignedByte32.java 11714 2009-03-23 20:05:37Z ehuelsmann $
 *
...
public final class ComplexArray_UnsignedByte32 extends AbstractArray
{
    ...
    public ComplexArray_UnsignedByte32(int[] dimv, LispArray array,
                                       int displacement)
    {
        this.dimv = dimv;
        this.array = array;
    ...
    {
        return list(SymbolConstants.ARRAY, UNSIGNED_BYTE_32, getDimensions());
    }
