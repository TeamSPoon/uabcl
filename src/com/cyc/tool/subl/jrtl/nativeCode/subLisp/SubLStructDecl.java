...
public class SubLStructDecl {
  ...
  public static final SubLStructDecl getStructDecl(SubLSymbol structName) {
    ...
    if (structDecl == null) {
      throw new SubLException("Invalid struct name: " + structName);
    }
    return structDecl;
  }
  ...
  public final int getFieldNumForSymbol(SubLSymbol symbol) {
    ...
    throw new SubLException(symbol + " is not a valid field of struct: " + structName);
  }
  ...
  public final void setStructName(SubLSymbol newStructName) {
    if (structName != SubLNil.NIL) {
      throw new SubLException("Can't set a structure's name twice: " + newStructName);
    }
  ...
  private static final Map structNameToStructDeclMap = new HashMap();
  private static final Map structNameToIDMap = new HashMap();
