...
public final class stream_macros extends SubLTranslatedFile {
  ...
  @SubL(source = "sublisp/stream-macros.lisp", position = 706) 
  public static final SubLObject ensure_private_stream(SubLObject macroform, SubLObject v_environment) {
    {
  ...
  @SubL(source = "sublisp/stream-macros.lisp", position = 1325) 
  public static final SubLObject cwith_output_to_string(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
  ...
  @SubL(source = "sublisp/stream-macros.lisp", position = 1692) 
  public static final SubLObject with_input_from_string(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
  ...
  @SubL(source = "sublisp/stream-macros.lisp", position = 2188) 
  ...
  @SubL(source = "sublisp/stream-macros.lisp", position = 2516) 
  public static final SubLObject with_open_stream(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
  ...
  @SubL(source = "sublisp/stream-macros.lisp", position = 3050) 
  public static final SubLObject with_open_file(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
  ...
  @SubL(source = "sublisp/stream-macros.lisp", position = 3503) 
  public static final SubLObject with_bounding_index_designators(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
  ...
  @SubL(source = "sublisp/stream-macros.lisp", position = 4174) 
  public static final SubLObject with_stream_lock(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
      SubLObject stream = NIL;
  ...
  @SubL(source = "sublisp/stream-macros.lisp", position = 4461) 
  public static final SubLObject synonym_stream_p(SubLObject macroform, SubLObject v_environment) {
    {
      SubLObject datum = macroform.rest();
      SubLObject current = datum;
      SubLObject stream = NIL;
  ...
  public static final SubLList $list1 = list(list(makeSymbol("*STREAM-REQUIRES-LOCKING*", "SUBLISP"), NIL));
  public static final SubLList $list2 = list(list(makeSymbol("STREAM-VAR", "SUBLISP"), makeSymbol("RESULT-VAR", "SUBLISP")), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLList $list10 = list(list(makeSymbol("VAR", "SUBLISP"), makeSymbol("STRING"), makeSymbol("&KEY"), makeSymbol("INDEX", "SUBLISP"), list(makeSymbol("START", "SUBLISP"), ZERO_INTEGER), makeSymbol("END", "SUBLISP")), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLSymbol $sym17$STREAM_INPUT_INDEX = makeSymbol("STREAM-INPUT-INDEX", "SUBLISP");
  public static final SubLList $list18 = list(list(makeSymbol("VAR", "SUBLISP"), makeSymbol("STREAM")), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLList $list21 = list(list(makeSymbol("STREAM"), makeSymbol("FILESPEC", "SUBLISP"), makeSymbol("&REST"), makeSymbol("KEYS", "SUBLISP")), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLList $list24 = list(list(makeSymbol("SEQUENCE"), makeSymbol("START-VAR", "SUBLISP"), makeSymbol("END-VAR", "SUBLISP")), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLList $list35 = list(makeSymbol("STREAM"), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  public static final SubLString $str36$LOCK_VAR = makeString("LOCK-VAR");
  public static final SubLSymbol $sym37$STREAM_LOCK = makeSymbol("STREAM-LOCK", "SUBLISP");
  ...
  public static final SubLSymbol $sym42$STREAM_STREAM_TYPE = makeSymbol("STREAM-STREAM-TYPE", "SUBLISP");
