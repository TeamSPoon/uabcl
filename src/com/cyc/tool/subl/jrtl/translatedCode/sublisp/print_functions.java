...
public final class print_functions extends SubLTranslatedFile {
  ...
  @SubL(source = "sublisp/print-functions.lisp", position = 675) 
...
a fixnum i.e. (FLOOR (LOG MOST-POSITIVE-FIXNUM RADIX)). */
  @SubL(source = "sublisp/print-functions.lisp", position = 1036) 
...
plus that power is the corresponding entry in *max-fixnum-base-power*. */
  @SubL(source = "sublisp/print-functions.lisp", position = 1758) 
  private static SubLSymbol $max_fixnum_power_less_one$ = null;

  @SubL(source = "sublisp/print-functions.lisp", position = 2494) 
  ...
  @SubL(source = "sublisp/print-functions.lisp", position = 3072) 
  ...
  @SubL(source = "sublisp/print-functions.lisp", position = 5889) 
  ...
  @SubL(source = "sublisp/print-functions.lisp", position = 6007) 
  ...
  @SubL(source = "sublisp/print-functions.lisp", position = 7290) 
  ...
  @SubL(source = "sublisp/print-functions.lisp", position = 13088) 
  ...
  @SubL(source = "sublisp/print-functions.lisp", position = 13208) 
  ...
  @SubL(source = "sublisp/print-functions.lisp", position = 13319) 
  ...
  @SubL(source = "sublisp/print-functions.lisp", position = 13459) 
  ...
  @SubL(source = "sublisp/print-functions.lisp", position = 13780) 
  ...
  public static final SubLObject setup_print_functions_file() {
    // CVS_ID("Id: print-functions.lisp,v 1.21 2006/03/10 20:03:13 goolsbey Exp ");
    {
  ...
  public static final SubLSymbol $sym2$PRINT_OBJECT_BIGNUM_METHOD = makeSymbol("PRINT-OBJECT-BIGNUM-METHOD", "SUBLISP");
  public static final SubLSymbol $sym3$PRINT_OBJECT_FIXNUM_METHOD = makeSymbol("PRINT-OBJECT-FIXNUM-METHOD", "SUBLISP");
  ...
  public static final SubLSymbol $sym7$PRINT_OBJECT_FLOAT_METHOD = makeSymbol("PRINT-OBJECT-FLOAT-METHOD", "SUBLISP");
  public static final SubLSymbol $sym8$PRINT_OBJECT_CHARACTER_METHOD = makeSymbol("PRINT-OBJECT-CHARACTER-METHOD", "SUBLISP");
  ...
  public static final SubLSymbol $sym14$PRINT_OBJECT_SYMBOL_METHOD = makeSymbol("PRINT-OBJECT-SYMBOL-METHOD", "SUBLISP");
  public static final SubLSymbol $sym15$PRINT_OBJECT_STRING_METHOD = makeSymbol("PRINT-OBJECT-STRING-METHOD", "SUBLISP");
  ...
  public static final SubLSymbol $sym20$PRINT_OBJECT_CONS_METHOD = makeSymbol("PRINT-OBJECT-CONS-METHOD", "SUBLISP");
  ...
  public static final SubLSymbol $sym25$PRINT_OBJECT_VECTOR_METHOD = makeSymbol("PRINT-OBJECT-VECTOR-METHOD", "SUBLISP");
  public static final SubLString $str26$TEST__A__D__D = makeString("TEST ~A ~D/~D");
  public static final SubLSymbol $sym27$PRINT_OBJECT_HASH_TABLE_METHOD = makeSymbol("PRINT-OBJECT-HASH-TABLE-METHOD", "SUBLISP");
  public static final SubLSymbol $sym28$PRINT_OBJECT_FUNCTION_METHOD = makeSymbol("PRINT-OBJECT-FUNCTION-METHOD", "SUBLISP");
  public static final SubLString $str29$_G = makeString("#G");
  public static final SubLSymbol $sym30$PRINT_OBJECT_GUID_METHOD = makeSymbol("PRINT-OBJECT-GUID-METHOD", "SUBLISP");
