...
public final class print_high extends SubLTranslatedFile {
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 574) 
  public static SubLSymbol $print_array$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 1790) 
  public static SubLSymbol $print_base$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 1816) 
  public static SubLSymbol $print_case$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 1846) 
  public static SubLSymbol $print_circle$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 1874) 
  public static SubLSymbol $print_escape$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 1900) 
  public static SubLSymbol $print_gensym$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 1926) 
  public static SubLSymbol $print_length$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 1954) 
  public static SubLSymbol $print_level$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 1981) 
  public static SubLSymbol $print_lines$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 2008) 
  public static SubLSymbol $print_miser_width$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 2041) 
  public static SubLSymbol $print_pprint_dispatch$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 2078) 
  public static SubLSymbol $print_pretty$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 2104) 
  public static SubLSymbol $print_radix$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 2131) 
  public static SubLSymbol $print_readably$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 2161) 
  public static SubLSymbol $print_right_margin$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 2195) 
  private static SubLSymbol $print_error$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 2276) 
  private static SubLSymbol $print_circularities$ = null;

  @SubL(source = "sublisp/print-high.lisp", position = 3290) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 3335) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 3592) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 3700) 
  public static final SubLObject with_printer_state(SubLObject macroform, SubLObject v_environment) {
    {
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 4862) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 5855) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 6797) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 6982) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 7846) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 9074) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 9223) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 9387) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 9802) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 10127) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 10270) 
  ...
  @SubL(source = "sublisp/print-high.lisp", position = 10413) 
  ...
  public static final SubLObject setup_print_high_file() {
    // CVS_ID("Id: print-high.lisp,v 1.12 2006/03/10 20:03:14 goolsbey Exp ");
    return NIL;
  }
  ...
  public static final SubLList $list3 = list(list(makeSymbol("STREAM-VAR", "SUBLISP"), makeSymbol("&KEY"), makeSymbol("NEWP", "SUBLISP")), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLSymbol $sym13$OUTPUT_STREAM_DESIGNATOR_STREAM = makeSymbol("OUTPUT-STREAM-DESIGNATOR-STREAM", "SUBLISP");
  ...
  public static final SubLList $list19 = list(makeSymbol("*PRINT-CIRCULARITIES*", "SUBLISP"));
  public static final SubLSymbol $sym20$CAND = makeSymbol("CAND");
  public static final SubLSymbol $sym21$CNOT = makeSymbol("CNOT");
  public static final SubLList $list22 = list(list(makeSymbol("MAKE-HASH-TABLE"), makeSymbol("*PRINT-CIRCLE-TABLE-SIZE*", "SUBLISP"), list(makeSymbol("FUNCTION"), EQ)));
  public static final SubLList $list23 = list(list(makeSymbol("MAKE-BROADCAST-STREAM"), NIL));
  public static final SubLSymbol $sym24$_PRINT_CIRCULARITIES_ = makeSymbol("*PRINT-CIRCULARITIES*", "SUBLISP");
  ...
  public static final SubLList $list30 = cons(makeSymbol("TABLE", "SUBLISP"), makeSymbol("COUNTER", "SUBLISP"));
  public static final SubLSymbol $sym31$REFERENCED = makeSymbol("REFERENCED", "SUBLISP");
  public static final SubLString $str32$__D_ = makeString("#~D=");
  public static final SubLString $str33$__D__ = makeString("#~D# ");
  public static final SubLSymbol $sym34$DETECTED = makeSymbol("DETECTED", "SUBLISP");
