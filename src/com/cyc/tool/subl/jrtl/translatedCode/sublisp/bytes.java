...
the least significant bit. */
  @SubL(source = "sublisp/bytes.lisp", position = 1143) 
  ...
  @SubL(source = "sublisp/bytes.lisp", position = 1707) 
...
into BITS according the the BYTESPEC. */
  @SubL(source = "sublisp/bytes.lisp", position = 2514) 
  ...
  public static final SubLObject setup_bytes_file() {
    // CVS_ID("Id: bytes.lisp,v 1.22 2006/03/10 20:02:49 goolsbey Exp ");
    return NIL;
  }
