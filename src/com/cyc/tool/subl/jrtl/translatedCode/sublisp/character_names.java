...
public final class character_names extends SubLTranslatedFile {
  ...
  @SubL(source = "sublisp/character-names.lisp", position = 431) 
  private static SubLSymbol $character_names_table$ = null;

  @SubL(source = "sublisp/character-names.lisp", position = 892) 
  ...
  @SubL(source = "sublisp/character-names.lisp", position = 1482) 
  ...
  public static final SubLObject setup_character_names_file() {
    // CVS_ID("Id: character-names.lisp,v 1.13 2007/08/16 22:30:35 tbrussea Exp ");
