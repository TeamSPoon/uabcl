...
public final class thread_macros extends SubLTranslatedFile {
  ...
  @SubL(source = "sublisp/thread-macros.lisp", position = 712) 
  public static final SubLObject with_lock_held(SubLObject macroform, SubLObject v_environment) {
    {
  ...
  @SubL(source = "sublisp/thread-macros.lisp", position = 1091) 
  public static final SubLObject with_lock_held_internal(SubLObject lock, SubLObject whostate, SubLObject body) {
    {
      ...
      return list($sym6$CLET, list(list(lock_var, lock)), list($sym7$CUNWIND_PROTECT, listS($sym8$PROGN, list($sym9$SEIZE_LOCK, lock_var), ConsesLow.append(body, NIL)), list($sym10$RELEASE_LOCK, lock_var)));
    }
  }
  ...
  public static final SubLList $list0 = list(list(makeSymbol("LOCK", "SUBLISP"), makeSymbol("&KEY"), list(makeSymbol("WHOSTATE", "SUBLISP"), makeString("Seize lock"))), makeSymbol("&BODY"), makeSymbol("BODY", "SUBLISP"));
  ...
  public static final SubLSymbol $sym7$CUNWIND_PROTECT = makeSymbol("CUNWIND-PROTECT");
  public static final SubLSymbol $sym8$PROGN = makeSymbol("PROGN");
  public static final SubLSymbol $sym9$SEIZE_LOCK = makeSymbol("SEIZE-LOCK", "SUBLISP");
  public static final SubLSymbol $sym10$RELEASE_LOCK = makeSymbol("RELEASE-LOCK", "SUBLISP");
