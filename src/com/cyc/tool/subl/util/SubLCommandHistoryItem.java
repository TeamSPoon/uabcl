...
public final class SubLCommandHistoryItem {
...
//TODO: temporary untill packages resolved
	  String sNewName = "LarKC";
	  if (packageName != "CYC")
		  sNewName+="-"+packageName;
    return /*packageName */ sNewName+ "(" + historyNum + "): ";
  }
